...
export const Footer = () => {
  return (
    <div className="full-width bg-slate-900 flex items-center h-80 p-4 py-8">
      <div className="container space-x-4 flex justify-evenly items-start mx-auto min-h-40">
        <div className="space-y-6">
          <h4 className="text-4xl font-bold text-center text-gray-200">
            Xclusive
          </h4>
          <h4 className="text-2xl font-medium text-center  text-gray-200">
            Subscribe
          </h4>
          ...
          <input
            ...
            className="form-input text-gray-100 py-4 bg-slate-800 rounded-md focus:border-slate-500 focus:ring-slate-400"
          />
        </div>

        <div className="space-y-6">
          <h4 className="text-2xl text-center font-medium text-gray-200">
            Subscribe
          </h4>
          <div>
            <p className="text-xl text-center text-gray-300">
            ...
            <p className="text-xl text-center text-gray-300">Lagos, Nigeria</p>
          </div>
          <div>
            <p className="text-xl text-center text-gray-300">
        ...
        <div className="space-y-3 flex flex-col">
          ...
          <Link
            href="/account"
            className="text-xl text-center text-gray-400 hover:text-gray-200"
          >
            My account
          </Link>
          <Link
        ...
        <div className="space-y-3 flex flex-col">
          <h4 className="text-2xl font-medium text-gray-200">Account</h4>
          <Link
            href="/account"
            className="text-xl text-center text-gray-400 hover:text-gray-200"
          >
