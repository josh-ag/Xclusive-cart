  ...
  return (
    <div className="min-w-full border-0 border-b border-slate-300">
      <div className="container flex justify-center items-center mx-auto h-20">
        ...
        <Link href="/" className="basis-1/4 font-medium text-2xl text-center">
          XClusive
        </Link>
        <div className="basis-3/4 flex justify-between items-center md: space-x-4">
          {/* Navigation section  */}
          <div className="basis-2/3 flex justify-center space-x-4">
          ...
          <div className="basis-1/4  flex space-x-5 items-center justify-center">
            <div className="relative hidden md:flex items-center">
              <input
                type="search"
                className="form-input rounded-md pr-10 border-0 bg-slate-100 focus:border-slate-500 focus:ring-slate-400"
